...
const Card = () => {
  return (
    <StyledWrapper>
      <div className="card">
        <span className="small-text">PREUZMI SADA</span>
        <span className="title">Preuzmi naše mobilne aplikacije</span>
...
const StyledWrapper = styled.div`
  .card {
    max-width: 350px;
    background-color: rgb(42, 77, 122);
    background: linear-gradient(45deg, rgb(42, 77, 122) 0%, rgb(156, 185, 214) 100%);
    background: -webkit-linear-gradient(to top right, rgb(42, 77, 122), rgb(156, 185, 214));
    display: flex;
